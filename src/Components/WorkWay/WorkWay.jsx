        ...
        <section className="max-w-container mx-auto pb-20 px-10 sm:md:px-48">
            ...
            <div className='absolute md:top-[325%] md:left-[55%] text-center '>
                ...
                <div className="btn flex justify-center mt-2">
                    <button className="border border-[#4262FF] rounded-[100px] px-3 py-3 bg-[#4262FF] transition hover:bg-white hover:text-black text-white flex items-center ">View the report<i className="ml-1"><MdArrowRightAlt /></i></button>
                </div>
            </div>
        </section>
    )
