        ...
        <section className="max-w-container mx-auto px-10 sm:md:px-32 pb-20">
            <div className=' sm:flex md:flex justify-between items-center'>
                <div className="workTogether-left w-[300px] sm:md:lg:w-[450px]">
                    <h1 className=' text-[30px] md:text-[30px] lg:text-[48px] md:w-[500px] '>Work together, <br /> wherever you work</h1>
                ...
                <div className="workTogether-right">
                    <img src={img} alt="" className='sm:w-[300px] sm:h-[300px] md:w-full md:h-full lg:h-full lg:w-full' />
                </div>
            </div>
        </section>
    )
